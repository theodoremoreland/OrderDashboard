...
const ordersSchema = z.object({
    ...
    date: z
        ...
        .refine(
            ...
            "Invalid data format. JSON Data must contain a date in the format of: 'Oct 13 2023'"
        ),
    cost: z.number(),
    itemCount: z.number(),
    ...
    dayOfWeek: z
        .string()
        .refine(
            (dayOfWeek) => /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun)$/.test(dayOfWeek),
            "Invalid data format. JSON data must contain a day of the week in the format of: 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'"
        ),
});
...
const DataUploadDialog = ({ open, handleClose }: Props): ReactElement => {
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <DialogContentText>
                    Visualize your own data by attaching a JSON file. The JSON
                    must feature order data in following format:
                </DialogContentText>
                <pre>
                    {`
[
    ...
    ...
                ...
                <DialogContentText>
                    ...
                    for information on how to get and format your order data.
                </DialogContentText>
